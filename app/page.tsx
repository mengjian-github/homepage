...
export default function Home() {
  const personSchema = {
    ...
    "knowsAbout": ["技术开发", "React", "Next.js", "TypeScript", "AI", "D2C", "DeepSeek"]
  };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">技术开发</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">精通 React、Vue、TypeScript 等现代技术栈，有大型应用架构设计经验。</p>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">深入研究 AI 与技术融合，专注 D2C、Copilot 等前沿技术。</p>
              <div className="flex flex-wrap gap-2">
